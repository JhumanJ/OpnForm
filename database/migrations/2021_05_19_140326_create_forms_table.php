...
class CreateFormsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('forms', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('workspace_id'); // Use unsignedBigInteger for foreign key
            $table->string('title');
            $table->string('slug');
            ...
            $table->string('re_fill_button_text')->default('Fill Again');
            ...
            $table->string('submitted_text')->default('Amazing, we saved your answers. Thank you for your time and have a great day!');
            ...
            $table->string('notification_body')->default('<p>Hello there 👋 <br>This is a confirmation that your submission was successfully saved.</p>');
