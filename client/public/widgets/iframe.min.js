...
!(function () {
    window.formSlug = document.currentScript.getAttribute('data-form-slug')
    console.log("formSlug", window.formSlug)
})()

document.addEventListener("DOMContentLoaded", function () {
    if (window.formSlug) {
        iFrameResize({ log: false, checkOrigin: false }, '#'+window.formSlug)
    }
})
...
window.addEventListener('message', function(event) {
    ...
    if (event.data?.form?.redirect_target_url) {
        window.top.open(event.data.form.redirect_target_url)
    }
})