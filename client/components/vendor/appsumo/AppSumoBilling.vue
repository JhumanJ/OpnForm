<template>
  <div v-if="user.active_license" class="border p-5 shadow-md rounded-md">
    <div class="w-auto flex flex-col items-center">
      <NuxtImg :src="`${useRuntimeConfig().public.appUrl}/img/appsumo/as-taco-white-bg.png`" class="max-w-[60px]" alt="AppSumo"/>

      <NuxtImg :src="`${useRuntimeConfig().public.appUrl}/img/appsumo/as-Select-dark.png`" class="max-w-[150px]" alt="AppSumo"/>
