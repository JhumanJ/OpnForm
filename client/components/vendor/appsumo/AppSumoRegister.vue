<template>
  <div v-if="hasValidLicense" class="p-6 bg-white border shadow-md rounded-md">
    <NuxtImg :src="`${useRuntimeConfig().public.appUrl}/img/appsumo/as-taco-white-bg.png`" class="max-w-[60px] mx-auto" alt="AppSumo"/>

    <NuxtImg :src="`${useRuntimeConfig().public.appUrl}/img/appsumo/as-Select-dark.png`" class="max-w-[300px] mx-auto" alt="AppSumo"/>
