<template>
  <div v-if="isVisible" class="relative group">
    <a class="github-button" href="https://github.com/jhumanj/opnform" data-color-scheme="no-preference: light; light: light; dark: dark;" data-size="large" data-show-count="true" aria-label="Star jhumanj/opnform on GitHub">Star</a>
    <UButton
