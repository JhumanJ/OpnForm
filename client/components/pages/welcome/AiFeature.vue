        ...
        <div class="mx-auto max-w-7xl isolate sm:px-6 lg:px-8">
          <div
            ...
            <div class="absolute inset-0">
              <NuxtImg class="object-cover object-top w-full h-full" :src="`${useRuntimeConfig().public.appUrl}/img/pages/ai_form_builder/background-pattern-ai.svg`" alt=""/>
            </div>
...
<!--                </v-button>-->
            ...
            <div
              ...
              :src="`${useRuntimeConfig().public.appUrl}/img/pages/ai_form_builder/ai-feature-illustration.svg`" alt="App screenshot"/>
