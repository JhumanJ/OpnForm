      ...
      <div class="mx-auto max-w-7xl isolate sm:px-6 lg:px-8">
        <div
          ...
          <div class="absolute inset-0">
            <img class="object-cover object-top w-full h-full" src="/img/pages/ai_form_builder/background-pattern-ai.svg"
              alt="">
          </div>
          ...
          <div class="relative max-w-md mx-auto text-center xl:max-w-lg lg:mx-0 lg:flex-auto lg:py-16 lg:text-left">
            ...
            <!-- <div class="mt-6 sm:mt-8 flex text-center justify-center lg:justify-start">
              <CommonButton v-if="!authenticated" class="mr-2 block" :to="{ name: 'forms.create.guest' }" :arrow="true">
                Get started for free
              </CommonButton>
              <CommonButton v-else class="mr-2 block" :to="{ name: 'forms.create' }" :arrow="true">
                Get started for free
              </CommonButton>
              <CommonButton color="light-gray" class="mr-1 block" :to="{ name: 'aiformbuilder' }">
                Learn more
              </CommonButton>
            </div> -->
          </div>
