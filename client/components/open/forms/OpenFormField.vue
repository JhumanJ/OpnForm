<template>
  <div
    ...
    :class="[
      ...
      {
        'group/nffield hover:bg-gray-100/50 relative hover:z-10 px-[15px] transition-colors hover:border-gray-200 dark:hover:bg-gray-900 border-dashed border border-transparent box-border dark:hover:border-blue-900 rounded-md':adminPreview,
