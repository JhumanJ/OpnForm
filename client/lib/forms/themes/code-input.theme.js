...
export const codeInputTheme = {
  ...
  variants: {
    theme: {
      ...
      transparent: { container: 'border-0 bg-transparent rounded-none shadow-[inset_0_-1px_0_0_rgb(212_212_212)] dark:shadow-[inset_0_-1px_0_0_rgb(82_82_82)] transition-shadow duration-200 focus-within:ring-0 focus-within:shadow-[inset_0_-2px_0_0_var(--color-form)]' }
    },
    size: {
