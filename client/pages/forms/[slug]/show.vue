<template>
  <div class="bg-white">
    <template v-if="form">
            ...
            <div class="flex flex-wrap">
              ...
              <div class="flex">
                ...
                <v-button v-if="form.visibility === 'draft'" color="white"
                          class="mr-2 text-blue-600 hidden sm:block" @click="draftFormWarningModal=true"
                >
      ...
      <modal :show="draftFormWarningModal" max-width="lg" @close="draftFormWarningModal=false">
        <div class="space-y-2 py-4">

          
          <p>This form is currently in 
            <span class="inline-flex items-center rounded-full bg-yellow-100 px-2 py-1 font-medium text-yellow-600 ring-1 ring-inset ring-gray-500/10 dark:text-white dark:bg-gray-700">
              Draft 
            </span> 
            and is not publicly accessible.</p>
          <p>You can change the form status on the edit form page.</p>
          <v-button class="text-white" :to="{name: 'forms-slug-edit', params: {slug: slug}}">
            <svg class="inline mr-1 -mt-1" width="18" height="17" viewBox="0 0 18 17" fill="none"
                  xmlns="http://www.w3.org/2000/svg"
            >
...
let draftFormWarningModal = ref(false)
