<template>
  <div class="w-full md:w-4/5 lg:w-3/5 md:mx-auto md:max-w-4xl p-4">
    ...
    <div
      v-if="false"
      class="pb-6 border-b w-full flex flex-col sm:flex-row gap-2"
    >
      <UCard class="text-center w-3/4">
        <template #header>
      ...
      <UCard class="text-center w-3/4">
        <template #header>
          <span class="font-semibold">Average Duration</span>
        </template>
        <Loader
          v-if="isLoading"
          class="h-6 w-6 text-nt-blue mx-auto"
