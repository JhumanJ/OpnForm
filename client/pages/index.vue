    ...
    <div>
        <section class="bg-gradient-to-b relative from-white to-gray-100 py-8 sm:py-16 ">
            <div class="absolute inset-0">
                <img class="w-full h-full object-cover object-top" src="/img/pages/ai_form_builder/background-pattern.svg"
                    alt="">
            </div>
            ...
            <div class="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative -mb-32 md:-mb-52 lg:-mb-72">
                <div class="flex justify-center mb-5">
                    <div
                        ...
                        <span class="font-semibold text-gray-500">We're Open-Source</span><span
                            class="h-4 w-px bg-gray-900/10" aria-hidden="true" />
                        <a target="_blank" class="flex items-center gap-x-1 hover:no-underline"
                ...
                <div class="max-w-4xl mx-auto text-center">
                    <h1 class="text-4xl sm:text-5xl lg:text-6xl font-semibold text-gray-900 tracking-tight">
                        Build
                        <span class="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-blue-400">beautiful
                            forms</span>
                        <br>
                        in seconds
                    </h1>
                    <p class="mt-4 sm:mt-5 text-base leading-7 sm:text-xl sm:leading-9 font-medium text-gray-500">
                        Create beautiful forms and share them anywhere. It super fast, you don't need to know how to code.
                        Get
                        started
                    ...
                    <div class="mt-8 flex justify-center">
                        <CommonButton v-if="!authenticated" class="mr-1" to="/forms/create/guest" :arrow="true">
                            Create a form for FREE
                        </CommonButton>
                        <CommonButton v-else class="mr-1" to="/forms/create" :arrow="true">
                            Create a form for FREE
                        </CommonButton>
                    </div>
                ...
                <div
                    ...
                    <div
                        ...
                        <img src="/img/pages/welcome/product-cover.jpg" alt="Product screenshot" loading="lazy"
        ...
        <div class="flex flex-col bg-gray-50 dark:bg-notion-dark">
            <div class="bg-white dark:bg-notion-dark-light pt-32 md:pt-52 lg:pt-72 pb-8">
                <div class="md:max-w-5xl md:mx-auto w-full">
                    <PagesWelcomeFeatures class="pb-8" />
                </div>
            </div>

            <PagesWelcomeAiFeature class="bg-white -mb-56" />

            <PagesWelcomeMoreFeatures class="pt-56" />

            <!-- <pricing-table v-if="paidPlansEnabled" class="pb-20" :home-page="true">
                <template #pricing-table>
                    <li class="flex gap-x-3">
                        <NuxtLink to="/pricing" class="flex gap-3">
                            <div class="w-5" />
            ...
            <PagesWelcomeTemplatesSlider class="max-w-full mb-12" />
            ...
            <div class="w-full bg-blue-900 p-12 md:p-24 text-center">
                ...
                <div class="mt-6 flex justify-center">
                    <CommonButton v-track.welcome_create_form_click to="/forms/create/guest" :arrow="true" color="blue">
                        Create a form for FREE
                    </CommonButton>
                </div>
