<template>
  <div v-if="field" class="p-4">
    ...
    <!-- Checkbox -->
    <div v-if="field.type === 'checkbox'" class="border-b mt-4">
      <h3 class="font-semibold block text-lg">
        Checkbox
      </h3>
      <p class="text-gray-400 mb-5 text-xs">
    ...
    <!-- File Uploads -->
    <div v-if="field.type === 'files'" class="border-b mt-4">
      <h3 class="font-semibold block text-lg">
        File uploads
      </h3>
    ...
    <!--   Number Options   -->
    <div v-if="field.type === 'number'" class="border-b mt-4">
      <h3 class="font-semibold block text-lg">
        Number Options
      </h3>
    ...
    <!--   Text Options   -->
    <div v-if="field.type === 'text' && displayBasedOnAdvanced" class="border-b mt-4">
      <h3 class="font-semibold block text-lg">
        Text Options
      </h3>
      <p class="text-gray-400 mb-5 text-xs">
    ...
    <!--   Date Options   -->
    <div v-if="field.type === 'date'" class="border-b mt-4">
      <h3 class="font-semibold block text-lg">
        Date Options
      </h3>
    ...
    <div v-if="['select','multi_select'].includes(field.type)" class="border-b mt-4">
      <h3 class="font-semibold block text-lg">
        Select Options
      </h3>
      <p class="text-gray-400 mb-5 text-xs">
    ...
    <div v-if="displayBasedOnAdvanced" class="border-b mt-4">
      <h3 class="font-semibold block text-lg">
        Customization
      </h3>
    ...
    <!--  Advanced Options   -->
    <div v-if="field.type === 'text'" class="border-b mt-4">
      <h3 class="font-semibold block text-lg">
        Advanced Options
      </h3>
