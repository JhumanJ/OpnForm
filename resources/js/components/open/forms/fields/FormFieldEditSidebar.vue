<template>
  <div v-if="showSidebar" class="w-full md:w-1/2 lg:w-2/5 border-l relative overflow-y-scroll md:max-w-sm flex-shrink-0">
    <div class="p-4 border-b sticky top-0 z-10 bg-white">
      ...
      <template v-if="field">
        <div class="font-semibold inline ml-2 truncate">
        ...
        <div class="flex mt-2">
          ...
          <change-field-type v-if="!isBlockField" class="ml-1" :field="field" @changeType="onChangeType"/>
        </div>
      </template>
    </div>
