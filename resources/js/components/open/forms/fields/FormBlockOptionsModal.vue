    ...
    <div v-if="field">
      <div class="flex">
        <h2 class="text-2xl font-semibold z-10 truncate mb-5 text-gray-900 flex-grow">
          Cấu hình "<span class="truncate">{{ field.name }}</span>" chặn
        </h2>
        <div class="flex mr-6">
          <div>
      ...
      <div class="-mx-4 sm:-mx-6 p-5 border-b border-t">
        <div class="-mx-4 sm:-mx-6 px-5 pt-0">
          ...
          <select-input name="width" class="mt-4" :options="[
          ...
          <select-input v-if="['nf-text', 'nf-image'].includes(field.type)" name="align" class="mt-4" :options="[
      ...
      <div v-else-if="field.type == 'nf-divider'" class="-mx-4 sm:-mx-6 p-5 border-b border-t">
        <text-input name="name" class="mt-4" :form="field" :required="true" label="Field Name" />
      </div>
      <div v-else-if="field.type == 'nf-image'" class="-mx-4 sm:-mx-6 p-5 border-b border-t">
        <text-input name="name" class="mt-4" :form="field" :required="true" label="Field Name" />
        <image-input name="image_block" class="mt-4" :form="field" label="Upload Image" :required="false" />
      </div>
