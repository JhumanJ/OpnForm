<template>
  <div v-if="showSidebar"
    ...
    <div class="py-2 px-4">
      <div>
        <p class="text-gray-500 uppercase text-xs font-semibold mb-2">Định dạng câu hỏi</p>
      ...
      <div class="border-t mt-6">
        <p class="text-gray-500 uppercase text-xs font-semibold mb-2 mt-6">Định dạng trình bày</p>
        <div class="grid grid-cols-2 gap-2">
