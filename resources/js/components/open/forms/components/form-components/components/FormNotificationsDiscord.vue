  ...
  <div>
    <button
      ...
      <div class="flex-grow flex items-center">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 inline" width="24" height="24" viewBox="0 0 24 24"
    ...
    <modal :show="showModal" @close="showModal=false">
      ...
      <template v-if="form.notifies_discord">
        <text-input name="discord_webhook_url" :form="form" class="mt-4" label="Discord webhook url" help="help">
          <template #help>
            Nhận thông báo qua Discord trên mỗi lần gửi biểu mẫu.
            <a href="https://support.discord.com/hc/en-us/articles/228383668-Intro-to-Webhooks" target="_blank">Nhấn vào
              đây</a> để biết cách lấy discord webhook url.
          </template>
        </text-input>
        <h4 class="font-bold mt-4">Discord tin nhắn hành động</h4>
