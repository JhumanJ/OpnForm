  ...
  <div>
    ...
    <modal :show="showModal" @close="showModal=false">
      ...
      <template v-if="form.notifies_slack">
        <text-input name="slack_webhook_url" :form="form" class="mt-4" label="Slack webhook url" help="help">
          <template #help>
            Nhận thông báo qua slack trên mỗi lần gửi biểu mẫu. <a href="https://api.slack.com/messaging/webhooks"
              target="_blank">Nhấn vào đây</a> để biết cách lấy slack webhook url
          </template>
        </text-input>
        <h4 class="font-bold mt-4">Slack hành động tin nhắn</h4>
