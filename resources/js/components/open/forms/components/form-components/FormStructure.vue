<template>
  <editor-options-panel name="Form Structure" v-model="isCollapseOpen">
    <template #icon>
      <svg class="h-5 w-5" :class="{'text-blue-600':isCollapseOpen, 'text-gray-500':!isCollapseOpen}" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
