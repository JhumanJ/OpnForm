<template>
  <editor-options-panel name="Link Settings - SEO" v-model="isCollapseOpen" :has-pro-tag="true">
    <template #icon>
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
          class="h-5 w-5" :class="{'text-blue-600':isCollapseOpen, 'text-gray-500':!isCollapseOpen}"
      >
