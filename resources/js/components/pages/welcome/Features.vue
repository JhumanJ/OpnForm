  ...
  <div id="features" class="px-4 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
    ...
    <div class="mb-16 max-w-xl md:mx-auto sm:text-center lg:max-w-2xl ">
      <h2
        ...
        Cách đơn giản nhất để tạo biểu mẫu. <br />
        Kế hoạch <span class="text-nt-blue">miễn phí</span> hấp dẫn không giới hạn.
      </h2>
      <p class="text-base text-gray-700 dark:text-gray-300 md:text-lg">
        Cần một biểu mẫu liên hệ? Làm cuộc khảo sát? Tạo biểu mẫu trong 2 phút và bắt đầu nhận các bài nộp.
      </p>
    </div>
    ...
    <div class="flex flex-wrap items-center mt-16" :class="{ 'md:flex-row-reverse': index % 2 == 1 }" v-for="(step, index) in [
      {
        title: 'Tạo',
        description: 'Tạo một biểu mẫu trong 2 phút. Hơn 10 loại đầu vào, hình ảnh, logic và nhiều tính năng khác.',
        features: [
          'Xây dựng một biểu mẫu đơn giản trong vài phút.',
          'Không cần viết mã.'
        ],
      ...
      {
        title: 'Chia sẻ',
        description: 'Biểu mẫu của bạn có một liên kết duy nhất mà bạn có thể chia sẻ mọi nơi. Gửi liên kết hoặc nhúng biểu mẫu trên trang web của bạn.',
        features: [
          'Chia sẻ liên kết đến biểu mẫu của bạn',
          'Nhúng biểu mẫu trên trang web của bạn'
        ],
        img: 'img/pages/welcome/step-2.jpg'
      },
      {
        title: 'Nhận Kết Quả',
        description: 'Nhận bài nộp từ biểu mẫu của bạn. Nhận thông báo, gửi xác nhận. Xuất các bài nộp và kiểm tra thống kê biểu mẫu của bạn.',
        features: [
          'Không giới hạn bài nộp biểu mẫu miễn phí',
          'Dễ dàng xuất bài nộp dưới dạng CSV',
          'Thống kê Lượt xem & Bài nộp'
        ],
      ...
      <div class="w-full md:w-1/2 lg:w-7/12 flex items-center justify-center relative w-full"
        ...
        <img loading="lazy" class="block rounded-2xl w-full" :src="asset(step.img)" alt="cover-product">
      </div>
    </div>
    ...
    <div class="grid md:grid-cols-3 mt-20">
      <div class="mb-8 md:mr-10">
        ...
        <h3 class="my-3 font-semibold">Thông Báo</h3>
        <p>Nhận thông báo trực tiếp trong Slack hoặc trong hộp thư của bạn mỗi khi biểu mẫu của bạn có một bài nộp mới
          (nếu bạn muốn).</p>
      </div>
      <div class="mb-8 md:mr-10">
        ...
        <h3 class="my-3 font-semibold">Tải Lên Tệp</h3>
        <p>Dễ dàng thêm các ô nhập tệp vào biểu mẫu của bạn. Các tệp được tải lên được lưu trữ an toàn cho bạn. Lên đến 5
          MB!</p>
      </div>
      <div class="mb-8 md:mr-10">
        <svg class="w-10 h-10 text-nt-blue" viewBox="0 0 45 44" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <h3 class="my-3 font-semibold">Tùy chỉnh Mọi Thứ</h3>
        <p>Thay đổi chủ đề biểu mẫu, thay đổi văn bản, màu sắc, thêm hình ảnh, thêm trang cảm ơn tùy chỉnh và nhiều tính
          năng khác.</p>
      </div>
    </div>
  </div>
