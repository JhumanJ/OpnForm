        ...
        <div
          ...
          <div class="absolute inset-0">
            <img class="object-cover object-top w-full h-full"
              :src="asset('img/pages/ai_form_builder/background-pattern-ai.svg')" alt="">
          </div>
          ...
          <div class="relative max-w-md mx-auto text-center xl:max-w-lg lg:mx-0 lg:flex-auto lg:py-16 lg:text-left">
            <span
              ...
              Giới thiệu e-Form AI
            </span>

            <h2 class="mt-6 text-2xl font-semibold tracking-tight text-gray-900 sm:text-3xl lg:text-4xl">
              Tạm biệt biểu mẫu đơn điệu với tính năng mới của e-Form <span
                class="text-transparent bg-clip-text bg-gradient-to-r lg:block from-blue-600 to-blue-300">Được hỗ trợ bới
                AI!</span>
            </h2>
            <p class="mt-4 text-base font-medium leading-7 text-gray-500 sm:text-lg sm:leading-8">
              Dễ dàng tạo biểu mẫu chỉ trong vài giây chỉ với mô tả đơn giản.
            </p>
