        ...
        <div class="max-w-5xl mx-auto bg-white shadow-xl rounded-3xl ring-1 ring-gray-200 lg:flex isolate">
          <div class="p-8 sm:p-8 lg:flex-auto">
            ...
            <p class="mt-2 text-base font-medium leading-7 text-gray-600">
              Gói OpnForm Pro mang lại các tính năng mạnh mẽ phù hợp với nhu cầu cao cấp của các nhóm và người sáng tạo. Hãy trải nghiệm bản dùng thử miễn phí của chúng tôi trong 3 ngày!
            </p>
            ...
            <div
              ...
              <div class="max-w-xs px-8 mx-auto space-y-6">
                ...
                <p v-if="!homePage" class="text-xs font-medium leading-5 text-gray-600">
                  Hóa đơn và biên nhận có sẵn để thuận tiện trong quá trình hoàn lại tiền của công ty.
                </p>
              </div>
            </div>
          </div>
...
export default {
  ...
  data: () => ({
    ...
    pricingInfo: [
      'Email xác nhận biểu mẫu',
      'Thông báo qua Slack',
      'Thông báo qua Discord',
      'Chỉnh sửa dữ liệu gửi',
      'Tên miền tùy chỉnh (sắp ra mắt)',
      'Mã tùy chỉnh',
      'Tải lên tệp lớn (50mb)',
      'Loại bỏ nhãn hiệu OpnForm',
      'Hỗ trợ ưu tiên'
    ]
  }),
