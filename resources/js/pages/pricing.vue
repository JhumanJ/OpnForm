      ...
      <div class="relative px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="max-w-4xl mx-auto text-center">
          <h1 class="text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl lg:text-6xl">
            Đơn giá minh bạch, không có bất ngờ.
          </h1>
          <p class="max-w-2xl mx-auto mt-4 text-base font-medium leading-7 text-gray-500 sm:mt-5 sm:text-xl sm:leading-9">
            Đơn giá của chúng tôi là hoàn toàn minh bạch. Một giá duy nhất cho tất cả các tính năng. Không có phí ẩn.
          </p>
        </div>
      </div>
    </section>
      ...
      <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="max-w-2xl mx-auto text-center">
          <h2 class="text-3xl font-semibold tracking-tight text-gray-900 sm:text-4xl lg:leading-tight">
            <span class="text-blue-600">99%</span> các tính năng đều miễn phí và không giới hạn cho tất cả người dùng.
          </h2>
        </div>
      ...
      <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="max-w-3xl mx-auto text-center">
          ...
          <p class="max-w-2xl mx-auto mt-4 text-base font-medium leading-7 text-gray-600 sm:text-lg sm:leading-8">
            Danh sách các câu hỏi phổ biến nhất.
          </p>
        </div>
        ...
        <div class="mt-12 text-center sm:mt-16">
          <p class="text-base font-medium text-gray-950">
            Không tìm thấy câu hỏi? <a href="#" @click.prevent="contactUs"
              class="font-semibold text-blue-600 hover:underline">Liên hệ</a>
          </p>
        </div>
      </div>
    </section>
